  ...
  const buttonMenuAdmin = [
    {
      ...
      text: "来店登録",
      onclick: () =>
        (window.location.href = `${URL_WEB}/k/${ID_APP_CUSTOMER_COME}/edit`),
    },
    {
      id: 3,
      text: "来店登録一覧",
      onclick: () =>
        (window.location.href = `${URL_WEB}/k/${ID_APP_CUSTOMER_COME}/`),
    },
    {
      id: 4,
      text: "顧客一覧",
      onclick: () =>
        (window.location.href = `${URL_WEB}/k/${ID_APP_CUSTOMER}/`),
    },
    {
      id: 5,
      text: "勤怠一覧",
    ...
    },
    {
      ...
      text: "損益目標設定",
      onclick: () =>
        (window.location.href = `${URL_WEB}/k/${ID_APP_CONFIG_SETTING}/`),
    },
    {
      id: 15,
      text: "在庫管理",
